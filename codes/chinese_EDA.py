#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2021/10/22 14:33
# @Author  : lilijuan
# @File    : chinese_EDA.py
import codes.synonyms.jieba as jieba
from codes.synonyms import synonyms
import random
...
if __name__ == '__main__':
    ...
    for text in texts:
        text = text.replace("\n", "")
        if len(text) > 2:
            aug_sentences = eda(text, alpha_sr=alpha, alpha_ri=alpha, alpha_rs=alpha, p_rd=alpha, num_aug=num_aug)
